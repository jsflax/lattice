...
#if defined(LATTICE_COLD_KEEPER_TIMING) && LATTICE_COLD_KEEPER_TIMING
    diagnostic.mark(detail::cold_keeper_timing::phase::busy_begin);
#endif
    if (read_control_) {
...
#if defined(LATTICE_COLD_KEEPER_TIMING) && LATTICE_COLD_KEEPER_TIMING
    diagnostic.mark(detail::cold_keeper_timing::phase::busy_end);
#endif
    // Enable foreign keys
    execute("PRAGMA foreign_keys = ON");
#if defined(LATTICE_COLD_KEEPER_TIMING) && LATTICE_COLD_KEEPER_TIMING
    diagnostic.mark(detail::cold_keeper_timing::phase::foreign_keys_end);
#endif
...
#if defined(LATTICE_COLD_KEEPER_TIMING) && LATTICE_COLD_KEEPER_TIMING
    diagnostic.mark(detail::cold_keeper_timing::phase::cache_end_setting);
#endif
    execute(read_control_ ? "PRAGMA temp_store = FILE" : "PRAGMA temp_store = MEMORY");      // Temp tables in RAM
#if defined(LATTICE_COLD_KEEPER_TIMING) && LATTICE_COLD_KEEPER_TIMING
    diagnostic.mark(detail::cold_keeper_timing::phase::temp_end);
#endif
#else
...
#if defined(LATTICE_COLD_KEEPER_TIMING) && LATTICE_COLD_KEEPER_TIMING
    diagnostic.mark(detail::cold_keeper_timing::phase::mmap_end);
#endif
    execute(read_control_ ? "PRAGMA temp_store = FILE" : "PRAGMA temp_store = MEMORY");      // Temp tables in RAM
#if defined(LATTICE_COLD_KEEPER_TIMING) && LATTICE_COLD_KEEPER_TIMING
    diagnostic.mark(detail::cold_keeper_timing::phase::temp_end);
...
#if defined(LATTICE_COLD_KEEPER_TIMING) && LATTICE_COLD_KEEPER_TIMING
#ifdef SQLITE_DBCONFIG_STMT_SCANSTATUS
    diagnostic.mark(detail::cold_keeper_timing::phase::settings_end,1);
#else
    diagnostic.mark(detail::cold_keeper_timing::phase::settings_end,0);
#endif
#endif
