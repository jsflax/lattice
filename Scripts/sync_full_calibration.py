...
from sync_probe_qualification import FLAGS
...
def prepare_binding(runner, root, sdk_inputs, core_inputs):
    ...
    if native['tests']['count'] != 14 or native['tests']['allExecutedWithoutFailure'] is not True:
        raise ValueError('native14 qualification is required before full calibration')
